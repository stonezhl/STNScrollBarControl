#
#  Be sure to run `pod spec lint STNScrollBarControl.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = "The scroll bar is subclass of UIControl and it is very easly added to scrollview/tableview/collectionview. It also can show text when implement delegate."
  ...
  # Or just: s.author    = "Stone Zhang"
  # s.authors            = { "Stone Zhang" => "stnzhl@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Stone Zhang"
